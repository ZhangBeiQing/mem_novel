        ...
        return [
            {
                ...
                "content": (
                    ...
                    "    - 对于延续事件：使用已存在的event_id，并在描述中体现发展\n"
                    ...
                    "    - **重要细节**：关键对话、动作、情感变化\n"
                    "    - **结果状态**：事件结束时的具体状况\n"
                    "    - 对于延续事件，使用【章节标记】清晰区分各阶段发展\n"
                    "    - 示例：\"段誉寻父真相事件：【核心目标】验证父亲段正淳的品格传言。【第一章】在无量山听钟灵述说父亲风流往事，内心震惊决心求证；【第二章】大理城中暗访调查，遇木婉清获得更多线索，情感复杂化；【第三章】天龙寺求教枯荣大师，通过佛理对话获得'血浓于水'的感悟，心境从怨恨转向理解。【当前状态】已基本接受父亲的过往，准备主动和解。\"\n"
